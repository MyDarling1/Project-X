  ...
  if (p === '/data.js') {
    fs.readFile(path.join(ROOT, 'data.json'), 'utf8', (e, txt) => e
      ...
      : send(res, 200, 'application/javascript; charset=utf-8',
          'const __D=' + txt + ';const DATA=__D.DATA,WK=__D.WK,FACT=__D.FACT,SAL=__D.SAL,COMM=__D.COMM||null,MON=__D.MON||null,SUMMARY=__D.SUMMARY||null,EXTRA=__D.EXTRA||null,UPD=__D.updatedAt||null;'));
    return;
  }
